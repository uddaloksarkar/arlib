...
The pinning vocabulary of `Arlib.MarkovChains.Chains.Pinning` is exactly what
...
`Arlib.MarkovChains.Chains.Glauber`. -/
...
This is the sense in which `Arlib.MarkovChains.Chains.Glauber` is a corollary of
